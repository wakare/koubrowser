...
Status: `R7_REAL_ACCOUNT_ACCEPTANCE_REVISION_4_AUTHORIZED_NOT_RUN`
...
request として project owner が承認した。execution authorization は `authorized`、status は not-run である。
